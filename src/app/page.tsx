...
const menuSections = [
  {
    title: "Fish & Chips",
    subtitle: "Traditional chip-shop classics.",
    items: [
      ["Fish & Chips", "£—"],
      ["Fish", "£—"],
      ["Chips", "£—"],
  ...
  {
    title: "Favourites",
    subtitle: "Proper village takeaway favourites.",
    items: [
      ["Sausage", "£—"],
      ["Fish Cake", "£—"],
      ["Spam Fritter", "£—"],
  ...
  {
    title: "Sides & Sauces",
    subtitle: "The extras that make the order.",
    items: [
      ["Mushy Peas", "£—"],
      ["Curry Sauce", "£—"],
      ["Gravy", "£—"],
  ...
  },
  {
    ...
    subtitle: "Family teas, quick bites and meal options.",
    items: [
      ["Cans", "£—"],
      ["Bottles", "£—"],
      ["Kids Meal", "£—"],
...
const featuredPhotos = [
  {
    ...
    alt: "Stonehouse’s fish and chips with mushy peas and tartare sauce",
    title: "Fish & chips",
  },
  {
  ...
  },
  {
    ...
    alt: "Spicy seasoned chips from Stonehouse’s",
...
const cookingPhotos = [
  {
    src: "/images/stonehouses-fresh-fish-fryer.jpg",
    alt: "Fresh battered fish being lifted from the fryer at Stonehouse’s",
    title: "Fresh from the fryer",
  },
  {
    src: "/images/stonehouses-battered-fish-drain.jpg",
    alt: "Battered fish draining after cooking at Stonehouse’s",
    title: "Crisp batter",
  },
  {
    src: "/images/stonehouses-fish-closeup-fryer.jpg",
    alt: "Close-up of battered fish at Stonehouse’s",
    title: "Cooked fresh",
  },
];
...
const structuredData = {
  ...
  image: [
    `${SITE_URL}/images/stonehouses-fish-and-chips-box.png`,
...
function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden border-b border-[#b89757]/30">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(184,151,87,0.22),transparent_34%),linear-gradient(to_bottom,rgba(11,13,11,0.35),#0b0d0b)]" />
      <WarmPattern />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 md:grid-cols-[1fr_.95fr] md:px-8 lg:py-24">
        <div>
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#b89757]/50 bg-[#b89757]/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.26em] text-[#ead39a]">
            ...
            1 High Street • Lingdale • TS12 3DZ
          </p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300 md:text-xl">
            ...
            service from a shop at the heart of the village.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {["Family run since 1999", "Freshly cooked", "Local village chippy"].map(
              (item) => (
                <span
                  key={item}
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-2xl">
            <Image
              ...
              alt="Stonehouse’s fish and chips served with sauces"
              width={1200}
              height={900}
  ...
  const items = [
    {
      ...
      text: "Proper chip-shop favourites cooked fresh.",
    },
    {
      icon: Sparkles,
      title: "Freshly Cooked",
      text: "Made with care and served properly.",
    },
    {
      icon: Heart,
      title: "Local Favourite",
      text: "A village shop with loyal local support.",
    },
    {
      icon: Users,
      title: "Friendly Service",
      text: "Straightforward food and friendly faces.",
    },
  ];
    ...
    <section className="mx-auto max-w-7xl px-5 py-20 md:px-8">
      <div className="mb-8 max-w-3xl">
        ...
        <h2 className="mt-3 font-serif text-4xl font-black md:text-5xl">
          Village chip-shop favourites, done properly.
        </h2>
        <p className="mt-4 leading-7 text-zinc-300">
          From fish and chips to burgers, sides and quick teas, Stonehouse’s is
          built around proper takeaway food for Lingdale and the surrounding
          villages.
        </p>
      </div>
        ...
        <div className="rounded-[2rem] border border-[#b89757]/20 bg-white/[0.04] p-8">
          ...
          <div className="mt-6 grid gap-4">
            {[
              ...
              <div
                key={item}
                className="rounded-2xl border border-white/10 bg-black/20 p-4 font-bold"
              >
                {item}
              </div>
            ))}
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 font-serif text-4xl font-black leading-tight md:text-5xl">
              Freshly battered, freshly cooked.
            </h2>
            <p className="mt-5 text-lg leading-8 text-zinc-300">
              The site should show what makes a chippy trustworthy: golden
              batter, fresh cooking, clean counters and food that looks like
              people actually want to eat it.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              These images make Stonehouse’s feel real, local and credible.
            </p>
          </div>
    ...
    <section id="menu" className="border-y border-white/10 bg-zinc-950/80 py-20">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="mt-4 leading-7 text-zinc-300">
            The full menu can be added from the shop board. For now, the site
            gives customers a clear idea of the core fish-and-chip favourites
            available.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {menuSections.map((section) => (
            <div
              key={section.title}
              className="rounded-3xl border border-[#b89757]/30 bg-[#0b0d0b] p-5 shadow-xl"
            >
        ...
        <p className="mx-auto mt-8 max-w-3xl text-center text-sm leading-6 text-zinc-500">
          Prices and availability can vary. Please check in-store or call the
          shop for the latest menu information.
        </p>
      </div>
    </section>
  );
